"""SE models based on slim library."""
...
from tslib.slim.nets import resnet_v2
...
def SE_model_generator(num_classes,
                              output_stride,
                              base_architecture,
                              pre_trained_model,
                              batch_norm_decay,
                              data_format='channels_last'):
  """Generator for SE plus models.
  ...
  Returns:
    ...
    returns the output tensor of the SE model.
  """
...
def SE_model_fn(features, labels, mode, params):
  ...
  network = SE_model_generator(params['num_classes'],
