...
parser.add_argument('--output_dir', type=str, default='./segmentation_result',
...
parser.add_argument('--model_dir', type=str, default='./model1',
...
def main(unused_argv):
  ...
  for filename in  os.listdir(FLAGS.data_dir):
      if os.path.isfile(os.path.join(FLAGS.data_dir, filename)):
          image_files.append(os.path.join(FLAGS.data_dir, filename))
  ...
  for pred_dict, image_path in zip(predictions, image_files):
    ...
    Image.fromarray(mask).save(path_to_output,'png')
